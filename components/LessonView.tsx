...
import { ArrowLeft, Clock, AlertTriangle, ExternalLink, CheckCircle, XCircle, Trophy, BookOpen, Volume2, Printer, Share2 } from 'lucide-react';
                  ...
                  {isPdf ? (
                     ...
                     />
                      ...
                      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                          ...
                          <h3 className="text-xl font-bold text-slate-700 mb-2">External Link</h3>
                          ...
                          <a 
                              ...
                              target="_blank" 
                              rel="noreferrer"
                              className="bg-blue-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:bg-blue-700 transition-all"
                          >
                              Open Content
                          </a>
                      </div>
    ...
    <div className="bg-white min-h-screen pb-20 animate-in fade-in">
       ...
       <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-sm border-b border-slate-100 px-4 py-3 flex items-center justify-between shadow-sm">
           ...
           <div className="flex gap-2">
               {/* Placeholder for future TTS or Share features */}
               <button className="p-2 text-slate-400 hover:text-blue-600 transition-colors" title="Read Aloud"><Volume2 size={20} /></button>
           </div>
       </div>
